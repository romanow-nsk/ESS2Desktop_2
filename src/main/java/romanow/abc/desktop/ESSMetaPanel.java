...
import romanow.abc.core.entity.metadata.iec61850.CIDCreateData;
import romanow.abc.core.entity.metadata.render.ScreenMode;
import romanow.abc.core.entity.metadata.snmp.MIBCreateData;
...
public class ESSMetaPanel extends ESSBasePanel {
    ...
    private void AddMetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddMetaActionPerformed
        ...
        new APICall<Artifact>(main){
            @Override
            public Call<Artifact> apiFun() {
                return main.getService().createArtifactFromString(main.getDebugToken(),"MetaData.xml","created by Wizard", false,new JString(dataString));
                }
            @Override
