...
import romanow.abc.core.entity.metadata.view.Meta2GUITimeInterval;
...
public class DesktopGUITimeInterval extends View2BaseDesktop {
    @Getter private JTextField textField;
    public DesktopGUITimeInterval(){
        setType(Values.GUITimeInterval);
        }
    @Override
    public void addToPanel(JPanel panel) {
        setLabel(panel);
        FormContext2 context= getContext();
        Meta2GUITimeInterval element = (Meta2GUITimeInterval) getElement();
