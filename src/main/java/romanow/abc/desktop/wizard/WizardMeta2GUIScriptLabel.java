 ...
 * @author romanow0
 */
public class WizardMeta2GUIScriptLabel extends WizardMeta2GUI {
    private Meta2GUIScriptLabel script;
    private boolean start=false;
    public WizardMeta2GUIScriptLabel() {
        initComponents();
        }
    public void openForm(WizardBaseView parentView0, Meta2Entity entity0){
        ...
        resizeHeight(200);
        start=true;
        script = (Meta2GUIScriptLabel)  entity;
