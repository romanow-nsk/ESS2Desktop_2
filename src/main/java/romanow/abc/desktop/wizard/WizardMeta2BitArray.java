 ...
 * @author romanow0
 */
public class WizardMeta2BitArray extends WizardBaseView {
    /**
     * Creates new form xxx
     */
    Meta2BitArray array;
    ArrayList<ConstValue> types;
    public WizardMeta2BitArray() {
        initComponents();
        }
    public void openForm(WizardBaseView parentView0, Meta2Entity entity0){
        super.openForm(parentView0,entity0);
        setSize(750,250);
        array = (Meta2BitArray) entity;
    ...
    private void SizeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SizeKeyPressed
        ...
        int xx=0;
        try {
            xx = Integer.parseInt(Size.getText());
            array.setSize(xx);
            if (evt!=null)
                main.viewUpdate(evt,true);
            back.onEnter("Изменено size: "+array.getSize());
            } catch (Exception ee){
                System.out.println("Ошибка целого: "+Size.getText());
                if (evt!=null)
    ...
    private void OwnBaseKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_OwnBaseKeyPressed
        ...
        int xx=0;
        try {
            xx = Integer.parseInt(Step.getText());
            array.setOwnBase(xx);
            if (evt!=null)
                main.viewUpdate(evt,true);
            back.onEnter("Изменено ownBase: "+array.getOwnBase());
        } catch (Exception ee){
            System.out.println("Ошибка целого: "+OwnBase.getText());
            if (evt!=null)
                main.viewUpdate(evt,false);
        }
    ...
    private void StepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StepKeyPressed
        ...
        try {
            ...
            if (evt!=null)
                main.viewUpdate(evt,true);
            back.onEnter("Изменено step: "+array.getStep());
        } catch (Exception ee){
            System.out.println("Ошибка целого: "+Step.getText());
            if (evt!=null)
                main.viewUpdate(evt,false);
            }
