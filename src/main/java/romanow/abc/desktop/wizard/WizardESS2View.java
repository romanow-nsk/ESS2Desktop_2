 ...
 * @author romanow0
 */
public class WizardESS2View extends WizardBaseViewDB {

    private ESS2Node node;
    private ESS2View equipment;
    ...
    private void SetMetaFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SetMetaFileActionPerformed
        ...
        if (!Values.isViewType(metaFile.getMetaType())) {
            main.popup("Недопустимый тип для мета-файла ЧМИ");
            return;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WizardESS2View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
