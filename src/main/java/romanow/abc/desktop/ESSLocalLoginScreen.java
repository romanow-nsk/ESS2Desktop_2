 ...
 * @author romanow
 */
public class ESSLocalLoginScreen extends ESSBaseView {

    /**
     * Creates new form ESSServiceGUIScreen
     */
    private int xC,yC;
    private String loginText="9130000000";
    private String passText="pi31415926";
    private ESSServiceGUIScreen screen=null;
    private final static int xMin=640;
    private final static int yMin=480;
    public ESSLocalLoginScreen(){
        this(false);
        }
    public ESSLocalLoginScreen(boolean min){
        super(xMin,yMin);
        Values.init();
        setUndecorated(true);
        initComponents();
    ...
    private  void initComponentsCenter(){
        Mes.setBounds(xC-200, yC*2-100, 450, 32);
    ...
    private void LoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LoginMouseClicked
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KeyBoardPanel(false,loginText,new I_Value<String>() {
                    @Override
    ...
    private void PasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PasswordMouseClicked
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KeyBoardPanel(false,passText,new I_Value<String>() {
                    @Override
                    public void onEnter(String value) {
                         passText = value;
                         Password.setText(passText);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ESSLocalLoginScreen().setVisible(true);
            }
        });
    }
