 ...
 * @author romanow
 */
public class ESSTimeSetting extends javax.swing.JFrame {
     ...
     */
    public ESSTimeSetting(MetaExternalSystem meta0, MetaSettingRegister register0, I_ModbusGroupDriver plm0, I_Success back0) {
        plm = plm0;
        back = back0;
        meta = meta0;
        register = register0;
    ...
    public void refreshSetting(){
        ...
        Calculator calculator = new Calculator(meta,false);
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ESSTimeSetting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ESSTimeSetting(null,null,null,null).setVisible(true);
            }
        });
    }
